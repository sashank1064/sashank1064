<h1 align="center">Hi, I'm Sashank Allugunti</h1>
...
<p align="center">
  ...
  &nbsp;
  <img src="https://komarev.com/ghpvc/?username=sashank1064&style=for-the-badge&color=0e75b6&label=PROFILE+VIEWS" alt="Profile Views" />
</p>
...
![CloudFormation](https://img.shields.io/badge/CloudFormation-FF9900?logo=amazonaws&logoColor=white&style=flat-square)
...
![EKS](https://img.shields.io/badge/EKS-FF9900?logo=amazonaws&logoColor=white&style=flat-square)
![kind](https://img.shields.io/badge/kind-326CE5?logo=kubernetes&logoColor=white&style=flat-square)
...
![Nexus](https://img.shields.io/badge/Nexus-1B1C30?logo=sonatype&logoColor=white&style=flat-square)
...
![New Relic](https://img.shields.io/badge/New_Relic-008C99?logo=newrelic&logoColor=white&style=flat-square)
![ELK](https://img.shields.io/badge/ELK_Stack-005571?logo=elasticstack&logoColor=white&style=flat-square)
![CloudWatch](https://img.shields.io/badge/CloudWatch-FF9900?logo=amazonaws&logoColor=white&style=flat-square)
...
![HCL](https://img.shields.io/badge/HCL-7B42BC?logo=terraform&logoColor=white&style=flat-square)
...
|---|---------|----------------|-------|
| 1 | [GitOps Drift Detection Controller](https://github.com/sashank1064/gitops-drift-controller) | Detects Kubernetes config drift between Git and live cluster state | Python, Kubernetes API, kind |
| 2 | [RoboShop Platform](https://github.com/sashank1064/roboshop-infra-dev) | Production AWS platform for an 11-service e-commerce app | Terraform, Ansible, AWS |
| 3 | [Cloud Native CI/CD on EKS](https://github.com/sashank1064/cloud-native-ci-cd) | Full container deployment pipeline from code to running EKS service | EKS, Helm, GitHub Actions, Docker |

---

#### Project 1: GitOps Drift Detection Controller

**Repo:** [sashank1064/gitops-drift-controller](https://github.com/sashank1064/gitops-drift-controller) &nbsp;|&nbsp; **Stack:** Python · Kubernetes API · kind · pytest
...
#### Project 2: RoboShop Platform

**Repo:** [sashank1064/roboshop-infra-dev](https://github.com/sashank1064/roboshop-infra-dev) &nbsp;|&nbsp; **Stack:** Terraform · Ansible · AWS · EC2 · CloudWatch
...
|------|---------------------|
| [roboshop-infra-dev](https://github.com/sashank1064/roboshop-infra-dev) | Full platform across 13 phased Terraform stacks |
| [terraform-aws-roboshop](https://github.com/sashank1064/terraform-aws-roboshop) | Per-component infra with ansible-pull bootstrap |
| [ansible-roboshop-roles-tf](https://github.com/sashank1064/ansible-roboshop-roles-tf) | Configuration layer applied by ansible-pull on first boot |

---

#### Project 3: Cloud Native CI/CD on EKS

**Repo:** [sashank1064/cloud-native-ci-cd](https://github.com/sashank1064/cloud-native-ci-cd) &nbsp;|&nbsp; **Stack:** EKS · ECR · Helm · GitHub Actions · Terraform · Docker
...
| Area | What it shows |
|------|--------------|
| Terraform | VPC, private/public subnets, EKS node group, ECR, IAM, OIDC provider, EKS access entry, SNS, CloudWatch alarm wiring |
| Kubernetes | Deployment, service, probes, ALB ingress, AWS Load Balancer Controller via IRSA |
...
**sashankallugunti@gmail.com** &nbsp;·&nbsp; [LinkedIn](https://www.linkedin.com/in/sashank-allugunti/)
